...
const EnvironmentalChart: React.FC<EnvironmentalChartProps> = ({ data, dataKey, color, title, unit, width = 300, height = 180 }) => {
  ...
  return (
    <div style={{ backgroundColor: '#333333', padding: '16px', borderRadius: '8px', marginBottom: '16px', position: 'relative' }}>
      <h4 style={{ margin: '0 0 12px 0', color: '#ffffff', fontSize: '14px', fontWeight: '600' }}>{title}</h4>
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
        <span style={{ fontSize: '24px', fontWeight: 'bold', color: '#ffffff', marginRight: '8px' }}>
      ...
      {hoveredPoint && (
        <div style={{
          ...
          <div style={{ color: '#888888' }}>{hoveredPoint.data.time}</div>
        </div>
      )}
...
const aiInsights = [
  { id: 1, title: 'Irrigation Optimization', description: 'Zone B requires 15% more water based on growth patterns', impact: 'high', confidence: 92 },
  { id: 2, title: 'Nutrient Deficiency Alert', description: 'Nitrogen levels are suboptimal in Zone C, recommend feeding', impact: 'medium', confidence: 87 },
  { id: 3, title: 'Harvest Window Optimization', description: 'Tomatoes in Zone A will reach peak ripeness in 3 days', impact: 'high', confidence: 95 },
];
...
function App() {
  ...
  const renderContent = () => {
    switch (activeSection) {
      case 'environmental':
        return (
          <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
            <h2 style={{ fontSize: '24px', fontWeight: 'bold', color: '#ffffff', marginBottom: '24px', marginTop: 0 }}>Environmental Monitoring</h2>
            
            {/* Current Status Cards */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '16px', marginBottom: '32px' }}>
              <div style={{ backgroundColor: '#333333', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '20px', marginBottom: '8px', color: '#ffffff' }}>◐</div>
                <p style={{ fontSize: '18px', fontWeight: 'bold', margin: '4px 0 2px 0', color: '#ffffff' }}>24.2°C</p>
                <p style={{ fontSize: '10px', color: '#00FF00', margin: 0 }}>Temperature</p>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '20px', marginBottom: '8px', color: '#ffffff' }}>◎</div>
                <p style={{ fontSize: '18px', fontWeight: 'bold', margin: '4px 0 2px 0', color: '#ffffff' }}>62%</p>
                <p style={{ fontSize: '10px', color: '#00FF00', margin: 0 }}>Humidity</p>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '20px', marginBottom: '8px', color: '#ffffff' }}>◈</div>
                <p style={{ fontSize: '18px', fontWeight: 'bold', margin: '4px 0 2px 0', color: '#ffffff' }}>375ppm</p>
                <p style={{ fontSize: '10px', color: '#00FF00', margin: 0 }}>CO₂ Level</p>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '20px', marginBottom: '8px', color: '#ffffff' }}>◇</div>
                <p style={{ fontSize: '18px', fontWeight: 'bold', margin: '4px 0 2px 0', color: '#ffffff' }}>1.9m/s</p>
                <p style={{ fontSize: '10px', color: '#00FF00', margin: 0 }}>Wind Speed</p>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '20px', marginBottom: '8px', color: '#ffffff' }}>◐</div>
                <p style={{ fontSize: '18px', fontWeight: 'bold', margin: '4px 0 2px 0', color: '#ffffff' }}>0 lux</p>
                <p style={{ fontSize: '10px', color: '#888888', margin: 0 }}>Light Intensity</p>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '20px', marginBottom: '8px', color: '#ffffff' }}>◉</div>
                <p style={{ fontSize: '18px', fontWeight: 'bold', margin: '4px 0 2px 0', color: '#ffffff' }}>1013hPa</p>
                <p style={{ fontSize: '10px', color: '#00FF00', margin: 0 }}>Pressure</p>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '20px', marginBottom: '8px', color: '#ffffff' }}>◐</div>
                <p style={{ fontSize: '18px', fontWeight: 'bold', margin: '4px 0 2px 0', color: '#ffffff' }}>22.0°C</p>
                <p style={{ fontSize: '10px', color: '#00FF00', margin: 0 }}>Soil Temp</p>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '20px', marginBottom: '8px', color: '#ffffff' }}>◎</div>
                <p style={{ fontSize: '18px', fontWeight: 'bold', margin: '4px 0 2px 0', color: '#ffffff' }}>46%</p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '24px', marginBottom: '32px' }}>
              {/* Zone Status */}
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Zone Status Overview</h3>
                {environmentalZones.map((zone) => (
                  <div key={zone.zone} style={{ 
                    ...
                    padding: '12px',
                    marginBottom: '8px',
                    backgroundColor: zone.status === 'optimal' ? '#1f3d1f' : zone.status === 'good' ? '#1f2a3d' : '#3d1f1f',
                    borderRadius: '6px',
                    border: `1px solid ${zone.status === 'optimal' ? '#00FF00' : zone.status === 'good' ? '#3b82f6' : '#ef4444'}`
                  }}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                      ...
                      <div>
                        <div style={{ fontSize: '16px', fontWeight: 'bold', color: '#ffffff' }}>Zone {zone.zone}</div>
                        <div style={{ fontSize: '12px', color: '#888888' }}>{zone.plants} plants</div>
                      </div>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <div style={{ fontSize: '14px', color: '#ffffff' }}>{zone.temp}°C | {zone.humidity}%</div>
                      <div style={{ fontSize: '12px', color: '#888888' }}>{zone.co2}ppm CO₂</div>
                    </div>
                    {zone.alerts > 0 && (
                      <div style={{ 
              ...
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Environmental Alerts</h3>
                {environmentalAlerts.map((alert) => (
                  <div key={alert.id} style={{
                    ...
                    padding: '12px',
                    marginBottom: '12px',
                    backgroundColor: alert.type === 'critical' ? '#3d1f1f' : alert.type === 'warning' ? '#3d3a1f' : '#1f3d3d',
                    borderRadius: '6px',
                    borderLeft: `4px solid ${alert.type === 'critical' ? '#ef4444' : alert.type === 'warning' ? '#f59e0b' : '#06b6d4'}`
                  }}>
                    <div style={{ fontSize: '16px', marginRight: '12px', color: '#ffffff' }}>
            ...
            {/* Weather Forecast */}
            <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>5-Day Weather Forecast</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px' }}>
                {weatherForecast.map((day, index) => (
                  <div key={index} style={{
                    ...
                    borderRadius: '8px',
                    textAlign: 'center',
                    border: index === 0 ? '2px solid #00FF00' : '1px solid #444444'
                  }}>
                    <div style={{ fontSize: '14px', fontWeight: 'bold', color: '#ffffff', marginBottom: '8px' }}>
                      {day.day}
                    </div>
      ...
      case 'plants':
        return (
          <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
            <h2 style={{ fontSize: '24px', fontWeight: 'bold', color: '#ffffff', marginBottom: '24px', marginTop: 0 }}>Plant Health Monitoring</h2>
            
            {/* Health Summary Dashboard */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px', marginBottom: '32px' }}>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#ffffff', marginBottom: '8px' }}>◉</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{plantHealthSummary.total}</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Total Plants</div>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '12px', color: '#888888' }}>Healthy</div>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '12px', color: '#888888' }}>Warning</div>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '12px', color: '#888888' }}>Critical</div>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#ffffff', marginBottom: '8px' }}>◈</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{plantHealthSummary.avgHealth}%</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Avg Health</div>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#ffffff', marginBottom: '8px' }}>◎</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{plantHealthSummary.readyToHarvest}</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Ready to Harvest</div>
              </div>
            </div>

            {/* Growth Stages Distribution */}
            <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', marginBottom: '32px' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Growth Stages Distribution</h3>
                ...
                {growthStages.map((stage) => (
                  <div key={stage.stage} style={{ 
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div>
                        <div style={{ fontSize: '14px', fontWeight: '500', color: '#ffffff', marginBottom: '2px' }}>{stage.stage}</div>
                        <div style={{ fontSize: '12px', color: '#888888' }}>{stage.count} plants</div>
                      </div>
            ...
            {/* Disease Alerts */}
            <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', marginBottom: '32px' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Disease & Health Alerts</h3>
              {diseaseAlerts.map((alert) => (
                <div key={alert.id} style={{
                  ...
                  padding: '12px',
                  marginBottom: '8px',
                  backgroundColor: alert.priority === 'high' ? '#3d1f1f' : alert.priority === 'medium' ? '#3d3a1f' : '#1f3d3d',
                  borderRadius: '6px',
                  borderLeft: `4px solid ${alert.priority === 'high' ? '#ef4444' : alert.priority === 'medium' ? '#f59e0b' : '#06b6d4'}`
                }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', marginBottom: '4px' }}>
                      <span style={{ fontSize: '14px', fontWeight: '500', color: '#ffffff', marginRight: '8px' }}>{alert.plant}</span>
                      <span style={{ 
                        fontSize: '10px', 
                        padding: '2px 6px', 
                    ...
                    <div style={{ fontSize: '12px', color: '#888888', marginBottom: '2px' }}>{alert.disease}</div>
                    <div style={{ fontSize: '11px', color: '#888888' }}>Action: {alert.action}</div>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '10px', color: '#888888' }}>{alert.detected}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            {/* Detailed Plant Grid */}
            <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Individual Plant Health</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '16px' }}>
                {plantHealthData.map((plant) => (
                  <div key={plant.id} style={{ 
                    ...
                    borderRadius: '8px', 
                    padding: '16px',
                    backgroundColor: plant.status === 'critical' ? '#3d1f1f' : plant.status === 'warning' ? '#3d3a1f' : '#1f3d1f',
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                      <div>
                        <h4 style={{ fontSize: '16px', fontWeight: '600', color: '#ffffff', margin: '0 0 4px 0' }}>{plant.name}</h4>
                        <p style={{ fontSize: '12px', color: '#888888', margin: '0 0 2px 0' }}>{plant.variety} • {plant.location}</p>
                        <p style={{ fontSize: '11px', color: '#888888', margin: 0 }}>Planted: {plant.plantedDate}</p>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ 
                          fontSize: '20px', 
                        ...
                        <div style={{ fontSize: '10px', color: '#888888' }}>Health Score</div>
                      </div>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '12px' }}>
                      <div style={{ fontSize: '11px' }}>
                        ...
                        <span style={{ color: '#ffffff', fontWeight: '500' }}>{plant.stage}</span>
                      </div>
                      <div style={{ fontSize: '11px' }}>
                        <span style={{ color: '#888888' }}>Height: </span>
                        <span style={{ color: '#ffffff', fontWeight: '500' }}>{plant.height}cm</span>
                      </div>
                      <div style={{ fontSize: '11px' }}>
                        <span style={{ color: '#888888' }}>pH: </span>
                        <span style={{ color: plant.ph >= 6.0 && plant.ph <= 7.0 ? '#00FF00' : '#FFFF00', fontWeight: '500' }}>{plant.ph}</span>
                      </div>
                      <div style={{ fontSize: '11px' }}>
                        <span style={{ color: '#888888' }}>Moisture: </span>
                        <span style={{ color: plant.moisture >= 60 ? '#00FF00' : plant.moisture >= 40 ? '#FFFF00' : '#FF6B6B', fontWeight: '500' }}>{plant.moisture}%</span>
                      </div>
                      <div style={{ fontSize: '11px' }}>
                        <span style={{ color: '#888888' }}>Leaves: </span>
                        <span style={{ color: '#ffffff', fontWeight: '500' }}>{plant.leafCount}</span>
                      </div>
                      <div style={{ fontSize: '11px' }}>
                        <span style={{ color: '#888888' }}>Light: </span>
      ...
      case 'irrigation':
        return (
          <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
            <h2 style={{ fontSize: '24px', fontWeight: 'bold', color: '#ffffff', marginBottom: '24px', marginTop: 0 }}>Irrigation & Nutrient Management</h2>
            
            {/* Irrigation Summary Dashboard */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '32px' }}>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#06b6d4', marginBottom: '8px' }}>◎</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{irrigationSummary.totalWaterUsage}L</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Total Water Used</div>
              ...
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{irrigationSummary.efficiency}%</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Water Efficiency</div>
              ...
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#ffffff', marginBottom: '8px' }}>◉</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{irrigationSummary.activeZones}</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Active Zones</div>
              ...
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{irrigationSummary.nutrientTankLevel}%</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Nutrient Level</div>
            ...
            {/* Zone Status Grid */}
            <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', marginBottom: '32px' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Irrigation Zone Status</h3>
                ...
                {irrigationZones.map((zone) => (
                  <div key={zone.id} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                      <div>
                        <h4 style={{ fontSize: '16px', fontWeight: '600', color: '#ffffff', margin: '0 0 4px 0' }}>Zone {zone.id} - {zone.name}</h4>
                        <div style={{ fontSize: '12px', color: '#888888' }}>{zone.plantCount} plants • Last: {zone.lastIrrigation}</div>
                      </div>
                      <div style={{
                        padding: '4px 8px',
                        borderRadius: '12px',
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginBottom: '12px' }}>
                      <div style={{ textAlign: 'center' }}>
                        ...
                        <div style={{ fontSize: '10px', color: '#888888' }}>Soil Moisture</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '18px', fontWeight: 'bold', color: zone.ph >= 6.0 && zone.ph <= 7.0 ? '#00FF00' : '#FFFF00' }}>
                          {zone.ph}
                        </div>
                        <div style={{ fontSize: '10px', color: '#888888' }}>pH Level</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '18px', fontWeight: 'bold', color: '#06b6d4' }}>
                          {zone.ec}
                        </div>
                        <div style={{ fontSize: '10px', color: '#888888' }}>EC (mS/cm)</div>
                      </div>
                    </div>
                    ...
                    <div style={{ marginBottom: '12px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                        <span style={{ fontSize: '11px', color: '#888888' }}>Water Usage</span>
                        <span style={{ fontSize: '11px', color: '#ffffff', fontWeight: '500' }}>{zone.waterUsed}L / {zone.target}L</span>
                      </div>
                      <div style={{ width: '100%', backgroundColor: '#444444', borderRadius: '4px', height: '6px' }}>
                        <div style={{
                    ...
                    {/* Additional Metrics */}
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11px', color: '#888888' }}>
                      <span>Pressure: <span style={{ color: '#ffffff' }}>{zone.pressure} bar</span></span>
                      <span>Soil Temp: <span style={{ color: '#ffffff' }}>{zone.soilTemp}°C</span></span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '24px', marginBottom: '32px' }}>
              {/* Irrigation Schedule */}
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Today's Irrigation Schedule</h3>
                {irrigationSchedule.map((schedule, index) => (
                  <div key={index} style={{
                    ...
                    padding: '12px',
                    marginBottom: '8px',
                    backgroundColor: schedule.status === 'completed' ? '#1f3d1f' : schedule.status === 'scheduled' ? '#3d3a1f' : '#2a2a2a',
                    borderRadius: '6px',
                    borderLeft: `4px solid ${schedule.status === 'completed' ? '#00FF00' : schedule.status === 'scheduled' ? '#f59e0b' : '#888888'}`
                  }}>
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '4px' }}>
                        <span style={{ fontSize: '14px', fontWeight: '600', color: '#ffffff', marginRight: '8px' }}>{schedule.time}</span>
                        <span style={{
                          fontSize: '10px',
                          padding: '2px 6px',
                      ...
                      <div style={{ fontSize: '12px', color: '#888888', marginBottom: '2px' }}>Zones: {schedule.zones.join(', ')} • {schedule.duration} min</div>
                      <div style={{ fontSize: '11px', color: '#888888' }}>{schedule.type} irrigation</div>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      ...
                      <div style={{ fontSize: '10px', color: '#888888' }}>Water Used</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              {/* Nutrient Management */}
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Nutrient Management</h3>
                {nutrientMixtures.map((nutrient) => (
                  <div key={nutrient.id} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
                      <div>
                        <div style={{ fontSize: '14px', fontWeight: '600', color: '#ffffff', marginBottom: '2px' }}>{nutrient.name}</div>
                        <div style={{ fontSize: '11px', color: '#888888' }}>{nutrient.ratio} • {nutrient.concentration} EC</div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ fontSize: '16px', fontWeight: 'bold', color: nutrient.tankLevel < 30 ? '#FF6B6B' : '#00FF00' }}>
                          {nutrient.tankLevel}%
                        </div>
                        <div style={{ fontSize: '10px', color: '#888888' }}>Tank Level</div>
                      </div>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11px', color: '#888888', marginBottom: '6px' }}>
                      <span>Usage: <span style={{ color: '#ffffff' }}>{nutrient.usage}</span></span>
                      <span>Target: <span style={{ color: '#ffffff' }}>{nutrient.target}</span></span>
                    </div>
                    {/* Tank Level Progress */}
                    <div style={{ width: '100%', backgroundColor: '#444444', borderRadius: '3px', height: '4px' }}>
                      <div style={{
            ...
            <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Water Quality Monitoring</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px' }}>
                {waterQualityMetrics.map((metric, index) => (
                  <div key={index} style={{
                    ...
                    <div style={{ fontSize: '12px', color: '#888888', marginBottom: '8px' }}>{metric.parameter}</div>
                    <div style={{ fontSize: '24px', fontWeight: 'bold', color: metric.color, marginBottom: '4px' }}>
                      {metric.value}{metric.unit}
                    </div>
                    <div style={{ fontSize: '10px', color: '#888888' }}>Optimal: {metric.optimal}</div>
                    <div style={{
                      marginTop: '8px',
                      padding: '2px 6px',
                      borderRadius: '8px',
                      fontSize: '9px',
                      fontWeight: '600',
                      backgroundColor: metric.status === 'optimal' ? '#1f3d1f' : '#3d1f1f',
      ...
      case 'harvest':
        return (
          <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
            <h2 style={{ fontSize: '24px', fontWeight: 'bold', color: '#ffffff', marginBottom: '24px', marginTop: 0 }}>AI-Powered Harvest Predictions</h2>
            
            {/* Harvest Summary Dashboard */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '32px' }}>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#00FF00', marginBottom: '8px' }}>◈</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{harvestSummary.totalPredictedYield}kg</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Predicted Yield</div>
              ...
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#06b6d4', marginBottom: '8px' }}>●</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{harvestSummary.efficiency}%</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Efficiency Rate</div>
                <div style={{ fontSize: '10px', color: '#00FF00', marginTop: '4px' }}>
                  ↑ 15.4% vs target
                </div>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#f59e0b', marginBottom: '8px' }}>◉</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{harvestSummary.readyToHarvest}</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Ready to Harvest</div>
                <div style={{ fontSize: '10px', color: '#888888', marginTop: '4px' }}>
              ...
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#10b981', marginBottom: '8px' }}>◎</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>${harvestSummary.marketValue}</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Market Value</div>
                <div style={{ fontSize: '10px', color: '#00FF00', marginTop: '4px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '24px', marginBottom: '32px' }}>
              {/* Harvest Calendar */}
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Harvest Calendar - Next 7 Days</h3>
                {harvestCalendar.slice(0, 5).map((day, index) => (
                  <div key={index} style={{
                    ...
                    padding: '12px',
                    marginBottom: '8px',
                    backgroundColor: day.priority === 'high' ? '#3d1f1f' : day.priority === 'medium' ? '#3d3a1f' : '#1f3d3d',
                    borderRadius: '6px',
                    borderLeft: `4px solid ${day.priority === 'high' ? '#ef4444' : day.priority === 'medium' ? '#f59e0b' : '#06b6d4'}`
                  }}>
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '4px' }}>
                        <span style={{ fontSize: '14px', fontWeight: '600', color: '#ffffff', marginRight: '8px' }}>{day.date}</span>
                        <span style={{
                          fontSize: '10px',
                          padding: '2px 6px',
                      ...
                      <div style={{ fontSize: '12px', color: '#888888', marginBottom: '2px' }}>{day.crops.join(', ')}</div>
                      <div style={{ fontSize: '11px', color: '#888888' }}>{day.totalYield}kg yield</div>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <div style={{ fontSize: '14px', fontWeight: 'bold', color: '#00FF00' }}>
                        ${day.value.toFixed(2)}
                      </div>
                      <div style={{ fontSize: '10px', color: '#888888' }}>Est. Value</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Yield Performance Analytics</h3>
                
                {/* Current Week */}
                <div style={{ marginBottom: '16px', padding: '12px', backgroundColor: '#2a2a2a', borderRadius: '6px' }}>
                  <div style={{ fontSize: '14px', fontWeight: '600', color: '#ffffff', marginBottom: '8px' }}>Current Week</div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                    <span style={{ fontSize: '12px', color: '#888888' }}>Predicted: {yieldAnalytics.currentWeek.predicted}kg</span>
                    <span style={{ fontSize: '12px', color: '#ffffff' }}>Actual: {yieldAnalytics.currentWeek.actual}kg</span>
                  </div>
                ...
                {/* Last Week */}
                <div style={{ marginBottom: '16px', padding: '12px', backgroundColor: '#2a2a2a', borderRadius: '6px' }}>
                  <div style={{ fontSize: '14px', fontWeight: '600', color: '#ffffff', marginBottom: '8px' }}>Last Week</div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                    <span style={{ fontSize: '12px', color: '#888888' }}>Predicted: {yieldAnalytics.lastWeek.predicted}kg</span>
                    <span style={{ fontSize: '12px', color: '#ffffff' }}>Actual: {yieldAnalytics.lastWeek.actual}kg</span>
                  </div>
            ...
            <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Detailed Crop Predictions</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(380px, 1fr))', gap: '16px' }}>
                {detailedHarvestPredictions.map((prediction) => (
                  <div key={prediction.id} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                      <div>
                        <h4 style={{ fontSize: '16px', fontWeight: '600', color: '#ffffff', margin: '0 0 4px 0' }}>{prediction.crop}</h4>
                        <div style={{ fontSize: '12px', color: '#888888' }}>{prediction.variety} • Zone {prediction.zone}</div>
                        <div style={{ fontSize: '11px', color: '#888888' }}>Planted: {prediction.plantedDate}</div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <div style={{
                          fontSize: '18px',
                        ...
                        <div style={{ fontSize: '10px', color: '#888888' }}>to harvest</div>
                      </div>
                    </div>
                    ...
                    <div style={{ marginBottom: '12px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                        <span style={{ fontSize: '11px', color: '#888888' }}>Growth Progress</span>
                        <span style={{ fontSize: '11px', color: '#ffffff', fontWeight: '500' }}>{prediction.stageProgress}% - {prediction.currentStage}</span>
                      </div>
                      <div style={{ width: '100%', backgroundColor: '#444444', borderRadius: '4px', height: '6px' }}>
                        <div style={{
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px', marginBottom: '12px' }}>
                      <div style={{ textAlign: 'center' }}>
                        ...
                        <div style={{ fontSize: '10px', color: '#888888' }}>Predicted Yield</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '16px', fontWeight: 'bold', color: '#06b6d4' }}>
                          {prediction.confidence}%
                        </div>
                        <div style={{ fontSize: '10px', color: '#888888' }}>Confidence</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
                      <div style={{
                        ...
                        fontSize: '11px',
                        fontWeight: '600',
                        backgroundColor: prediction.quality === 'Premium' ? '#1f3d1f' : prediction.quality === 'High' ? '#1f2a3d' : '#3d3a1f',
                    ...
                    <div style={{ marginBottom: '8px' }}>
                      ...
                      {prediction.aiFactors.slice(0, 2).map((factor, index) => (
                        <div key={index} style={{ fontSize: '10px', color: '#888888', marginLeft: '12px', marginBottom: '2px' }}>• {factor}</div>
                      ))}
                    </div>
                    ...
                    {/* Market Info */}
                    <div style={{ marginTop: '12px', padding: '8px', backgroundColor: '#1a1a1a', borderRadius: '4px', fontSize: '10px', color: '#888888' }}>
                      Market Price: <span style={{ color: '#ffffff' }}>${prediction.marketPrice}/kg</span> • 
                      Size: <span style={{ color: '#ffffff' }}>{prediction.size}</span> • 
                      Harvest: <span style={{ color: '#ffffff' }}>{prediction.predictedHarvestDate}</span>
                    </div>
                  </div>
                ))}
              </div>
      ...
      case 'ai-insights':
        return (
          <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
            <h2 style={{ fontSize: '24px', fontWeight: 'bold', color: '#ffffff', marginBottom: '24px', marginTop: 0 }}>AI Insights & Recommendations</h2>
            
            {/* AI Analytics Summary */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '32px' }}>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#06b6d4', marginBottom: '8px' }}>◇</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{aiAnalyticsSummary.totalInsights}</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>AI Insights</div>
              ...
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#00FF00', marginBottom: '8px' }}>◈</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{aiAnalyticsSummary.predictiveAccuracy}%</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Prediction Accuracy</div>
                <div style={{ fontSize: '10px', color: '#00FF00', marginTop: '4px' }}>
                  ↑ +2.8% this month
                </div>
              </div>
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#f59e0b', marginBottom: '8px' }}>◉</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>{aiAnalyticsSummary.optimizationOpportunities}</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Optimizations</div>
              ...
              <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
                <div style={{ fontSize: '24px', color: '#10b981', marginBottom: '8px' }}>◎</div>
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', marginBottom: '4px' }}>${aiAnalyticsSummary.costSavings}</div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Cost Savings</div>
            ...
            <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', marginBottom: '32px' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>System Recommendations</h3>
                ...
                <div style={{ marginBottom: '16px' }}>
                  ...
                  {systemRecommendations.immediate.map((rec, index) => (
                    <div key={index} style={{
                      ...
                      <div style={{ color: '#ffffff', marginBottom: '2px' }}>{rec.action}</div>
                      <div style={{ color: '#888888' }}>Impact: {rec.impact}</div>
                    </div>
                  ))}
                </div>
            ...
            <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px', marginBottom: '32px' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Predictive Analytics Dashboard</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
                {/* Next Week Yield */}
                <div style={{ backgroundColor: '#2a2a2a', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                  <div style={{ fontSize: '14px', color: '#888888', marginBottom: '8px' }}>Next Week Yield</div>
                  <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#00FF00', marginBottom: '4px' }}>
                    {predictiveAnalytics.nextWeekYield.predicted}kg
                  </div>
                  <div style={{ fontSize: '10px', color: '#888888' }}>Confidence: {predictiveAnalytics.nextWeekYield.confidence}%</div>
                  <div style={{ fontSize: '10px', color: '#00FF00', marginTop: '4px' }}>
                ...
                <div style={{ backgroundColor: '#2a2a2a', padding: '16px', borderRadius: '8px' }}>
                  <div style={{ fontSize: '14px', color: '#888888', marginBottom: '8px', textAlign: 'center' }}>Resource Efficiency</div>
                  <div style={{ fontSize: '11px', marginBottom: '4px' }}>
                    <span style={{ color: '#888888' }}>Water: </span>
                    <span style={{ color: '#06b6d4', fontWeight: '500' }}>{predictiveAnalytics.resourceEfficiency.water}%</span>
                  </div>
                  <div style={{ fontSize: '11px', marginBottom: '4px' }}>
                    <span style={{ color: '#888888' }}>Energy: </span>
                    <span style={{ color: '#f59e0b', fontWeight: '500' }}>{predictiveAnalytics.resourceEfficiency.energy}%</span>
                  </div>
                  <div style={{ fontSize: '11px' }}>
                    <span style={{ color: '#888888' }}>Nutrients: </span>
                ...
                {/* Quality Projection */}
                <div style={{ backgroundColor: '#2a2a2a', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                  <div style={{ fontSize: '14px', color: '#888888', marginBottom: '8px' }}>Quality Projection</div>
                  <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#00FF00', marginBottom: '4px' }}>
                    {predictiveAnalytics.qualityProjection.overall}%
                  </div>
                  <div style={{ fontSize: '10px', color: '#888888' }}>Premium: {predictiveAnalytics.qualityProjection.premium}%</div>
                  <div style={{ fontSize: '10px', color: '#888888' }}>Commercial: {predictiveAnalytics.qualityProjection.commercial}%</div>
                </div>

                {/* Profitability Forecast */}
                <div style={{ backgroundColor: '#2a2a2a', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
                  <div style={{ fontSize: '14px', color: '#888888', marginBottom: '8px' }}>Profitability</div>
                  <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#00FF00', marginBottom: '4px' }}>
                    {predictiveAnalytics.profitabilityForecast.margin}%
                  </div>
                  <div style={{ fontSize: '10px', color: '#888888' }}>Revenue: ${predictiveAnalytics.profitabilityForecast.revenue}</div>
                  <div style={{ fontSize: '10px', color: '#888888' }}>Costs: ${predictiveAnalytics.profitabilityForecast.costs}</div>
                </div>
              </div>
            </div>
            ...
            <div style={{ backgroundColor: '#333333', padding: '20px', borderRadius: '8px' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Detailed AI Insights</h3>
                ...
                {comprehensiveAiInsights.map((insight) => (
                  <div key={insight.id} style={{
                    ...
                    border: `2px solid ${
                      ...
                      insight.impact === 'medium' ? '#06b6d4' : '#10b981'
                    }`,
                    transition: 'transform 0.2s ease',
                    cursor: 'pointer'
                  }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                      <div>
                        <div style={{
                          fontSize: '10px',
                          padding: '2px 6px',
                          backgroundColor: insight.impact === 'critical' ? '#3d1f1f' : insight.impact === 'high' ? '#3d3a1f' : '#1f3d3d',
                        ...
                        <h4 style={{ fontSize: '16px', fontWeight: '600', color: '#ffffff', margin: '0 0 4px 0' }}>{insight.title}</h4>
                        <div style={{ fontSize: '11px', color: '#888888' }}>AI Model: {insight.aiModel}</div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <div style={{
                          fontSize: '18px',
                    ...
                    {/* Description */}
                    <p style={{ fontSize: '14px', color: '#888888', margin: '0 0 12px 0', lineHeight: '1.4' }}>{insight.description}</p>

                    {/* Expected Gains & Implementation */}
                    <div style={{ marginBottom: '12px' }}>
                      <div style={{ fontSize: '12px', color: '#00FF00', fontWeight: '500', marginBottom: '4px' }}>✓ Expected Gains:</div>
                      <div style={{ fontSize: '11px', color: '#ffffff', marginLeft: '12px', marginBottom: '6px' }}>{insight.expectedGains}</div>
                      
                      <div style={{ fontSize: '12px', color: '#06b6d4', fontWeight: '500', marginBottom: '4px' }}>⚙ Implementation:</div>
                      <div style={{ fontSize: '11px', color: '#ffffff', marginLeft: '12px' }}>{insight.implementation}</div>
                    </div>

                    {/* Metrics & Tags */}
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '12px' }}>
                      <div style={{ fontSize: '11px' }}>
                        <span style={{ color: '#888888' }}>Data Points: </span>
                        <span style={{ color: '#ffffff', fontWeight: '500' }}>{insight.dataPoints}</span>
                      </div>
                      <div style={{ fontSize: '11px' }}>
                        <span style={{ color: '#888888' }}>Risk Level: </span>
                        <span style={{ 
                      ...
                      <div style={{ fontSize: '11px' }}>
                        <span style={{ color: '#888888' }}>Priority: </span>
                        <span style={{ 
                      ...
                      <div style={{ fontSize: '11px' }}>
                        <span style={{ color: '#888888' }}>Timeline: </span>
                        <span style={{ color: '#ffffff', fontWeight: '500' }}>{insight.timeframe}</span>
                      </div>
                    </div>
        ...
        return (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '24px' }}>
              <div style={{ backgroundColor: '#2a2a2a', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <p style={{ fontSize: '12px', color: '#888888', margin: '0 0 4px 0' }}>Active Plants</p>
                    <p style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', margin: 0 }}>1,247</p>
                  </div>
                  <div style={{ fontSize: '40px', color: '#ffffff' }}>◉</div>
                </div>
              ...
              <div style={{ backgroundColor: '#2a2a2a', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <p style={{ fontSize: '12px', color: '#888888', margin: '0 0 4px 0' }}>Avg Health Score</p>
                    <p style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', margin: 0 }}>89.2%</p>
                  </div>
                  <div style={{ fontSize: '40px', color: '#ffffff' }}>▤</div>
                </div>
              ...
              <div style={{ backgroundColor: '#2a2a2a', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <p style={{ fontSize: '12px', color: '#888888', margin: '0 0 4px 0' }}>Water Efficiency</p>
                    <p style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', margin: 0 }}>92.5%</p>
                  </div>
                  <div style={{ fontSize: '40px', color: '#ffffff' }}>◎</div>
                </div>
              ...
              <div style={{ backgroundColor: '#2a2a2a', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <p style={{ fontSize: '12px', color: '#888888', margin: '0 0 4px 0' }}>Energy Usage</p>
                    <p style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', margin: 0 }}>23.4kW</p>
                  </div>
                  <div style={{ fontSize: '40px', color: '#ffffff' }}>◈</div>
                </div>
              ...
              <div style={{ backgroundColor: '#2a2a2a', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <p style={{ fontSize: '12px', color: '#888888', margin: '0 0 4px 0' }}>AI Accuracy</p>
                    <p style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', margin: 0 }}>94.2%</p>
                  </div>
                  <div style={{ fontSize: '40px', color: '#ffffff' }}>◇</div>
                </div>
              ...
              <div style={{ backgroundColor: '#2a2a2a', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <p style={{ fontSize: '12px', color: '#888888', margin: '0 0 4px 0' }}>Revenue Today</p>
                    <p style={{ fontSize: '28px', fontWeight: 'bold', color: '#ffffff', margin: 0 }}>$287</p>
                  </div>
                  <div style={{ fontSize: '40px', color: '#ffffff' }}>◐</div>
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px', marginBottom: '24px' }}>
              {/* Production Summary */}
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Production Summary</h3>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
                  <div style={{ textAlign: 'center', padding: '12px', backgroundColor: '#333333', borderRadius: '8px' }}>
                    <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#00FF00' }}>18.7kg</div>
                    <div style={{ fontSize: '12px', color: '#888888' }}>Weekly Yield</div>
                  </div>
                  <div style={{ textAlign: 'center', padding: '12px', backgroundColor: '#333333', borderRadius: '8px' }}>
                ...
                <div style={{ padding: '12px', backgroundColor: '#1f3d1f', borderRadius: '6px', marginBottom: '8px' }}>
                  <div style={{ fontSize: '14px', color: '#00FF00', fontWeight: '500' }}>Top Performers:</div>
                  <div style={{ fontSize: '12px', color: '#ffffff', marginTop: '4px' }}>Sweet Basil (98% health), Wild Arugula (95% health)</div>
                </div>
                <div style={{ fontSize: '12px', color: '#888888' }}>Market Value: <span style={{ color: '#00FF00', fontWeight: 'bold' }}>$142.50</span></div>
              </div>

              {/* System Health Overview */}
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>System Health Overview</h3>
                <div style={{ marginBottom: '16px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                    <span style={{ fontSize: '14px', color: '#888888' }}>Environmental Status</span>
                    <span style={{ fontSize: '14px', color: '#00FF00', fontWeight: '500' }}>Optimal</span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                    <span style={{ fontSize: '14px', color: '#888888' }}>Irrigation Systems</span>
                    <span style={{ fontSize: '14px', color: '#00FF00', fontWeight: '500' }}>Active (6/6)</span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                    <span style={{ fontSize: '14px', color: '#888888' }}>AI Models</span>
                    <span style={{ fontSize: '14px', color: '#00FF00', fontWeight: '500' }}>Online (6/6)</span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                    <span style={{ fontSize: '14px', color: '#888888' }}>Sensor Network</span>
                    <span style={{ fontSize: '14px', color: '#FFFF00', fontWeight: '500' }}>98.5% Uptime</span>
                  </div>
                </div>
                <div style={{ padding: '12px', backgroundColor: '#3d1f1f', borderRadius: '6px' }}>
                  <div style={{ fontSize: '12px', color: '#FF6B6B', fontWeight: '500' }}>⚠ Active Alerts: 2</div>
                  <div style={{ fontSize: '11px', color: '#888888', marginTop: '2px' }}>Zone C pH critical, Bell Pepper aphids detected</div>
                </div>
              </div>

              {/* Resource Utilization */}
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Resource Utilization</h3>
                <div style={{ marginBottom: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                    <span style={{ fontSize: '12px', color: '#888888' }}>Water Usage</span>
                    <span style={{ fontSize: '12px', color: '#06b6d4', fontWeight: '500' }}>2,847L / 3,200L</span>
                  </div>
                  <div style={{ width: '100%', height: '6px', backgroundColor: '#333333', borderRadius: '3px', overflow: 'hidden' }}>
                    <div style={{ width: '89%', height: '100%', backgroundColor: '#06b6d4' }}></div>
                  </div>
                </div>
                <div style={{ marginBottom: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                    <span style={{ fontSize: '12px', color: '#888888' }}>Nutrients</span>
                ...
                <div style={{ marginBottom: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                    <span style={{ fontSize: '12px', color: '#888888' }}>Energy</span>
                ...
                <div style={{ fontSize: '11px', color: '#888888', marginTop: '12px' }}>Cost Savings: <span style={{ color: '#00FF00', fontWeight: 'bold' }}>$1,847 this month</span></div>
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '24px' }}>
              {/* Critical Alerts */}
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Critical Alerts</h3>
                <div style={{ display: 'flex', alignItems: 'center', padding: '12px', backgroundColor: '#3d1f1f', borderRadius: '8px', marginBottom: '12px' }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '12px', color: '#888888', margin: 0 }}>pH 5.2 - Immediate attention required</p>
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', padding: '12px', backgroundColor: '#3d3a1f', borderRadius: '8px', marginBottom: '12px' }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '12px', color: '#888888', margin: 0 }}>Minor infestation detected - Apply treatment</p>
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', padding: '12px', backgroundColor: '#1f3d1f', borderRadius: '8px' }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '12px', color: '#888888', margin: 0 }}>All conditions within ideal range</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Today's Harvest Schedule</h3>
                {harvestCalendar.slice(0, 3).map((day, index) => (
                  <div key={index} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px', padding: '12px', backgroundColor: '#333333', borderRadius: '6px' }}>
                    <div>
                      <p style={{ fontSize: '14px', fontWeight: '500', color: '#ffffff', margin: '0 0 2px 0' }}>{day.crops.join(', ')}</p>
                      <p style={{ fontSize: '12px', color: '#888888', margin: 0 }}>{day.date} • {day.totalYield}kg expected</p>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <div style={{ 
                        fontSize: '10px',
              ...
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Growth Progress by Stage</h3>
                {growthStages.map((stage, index) => (
                  <div key={index} style={{ marginBottom: '12px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                      <span style={{ fontSize: '14px', color: '#ffffff' }}>{stage.stage}</span>
                ...
                <div style={{ marginTop: '16px', padding: '8px', backgroundColor: '#333333', borderRadius: '6px', fontSize: '12px', color: '#888888' }}>
              ...
              {/* AI Insights Summary */}
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>AI Insights Summary</h3>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                  <div style={{ textAlign: 'center', padding: '12px', backgroundColor: '#333333', borderRadius: '8px' }}>
                    <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#06b6d4' }}>24</div>
                    <div style={{ fontSize: '11px', color: '#888888' }}>Total Insights</div>
                  </div>
                  <div style={{ textAlign: 'center', padding: '12px', backgroundColor: '#333333', borderRadius: '8px' }}>
                    <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#ef4444' }}>3</div>
                    <div style={{ fontSize: '11px', color: '#888888' }}>Critical Actions</div>
                  </div>
                </div>
                <div style={{ marginBottom: '12px' }}>
                  <div style={{ fontSize: '12px', color: '#00FF00', fontWeight: '500', marginBottom: '4px' }}>Top Recommendation:</div>
                  <div style={{ fontSize: '11px', color: '#ffffff', backgroundColor: '#1f3d1f', padding: '8px', borderRadius: '4px' }}>
                    Extend LED lighting for Zone A tomatoes to increase yield by 18%
                  </div>
                </div>
                <div style={{ fontSize: '11px', color: '#888888' }}>Potential Savings: <span style={{ color: '#00FF00', fontWeight: 'bold' }}>$1,847/month</span></div>
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '24px' }}>
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>System Alerts</h3>
                <div style={{ display: 'flex', alignItems: 'center', padding: '12px', backgroundColor: '#3d1f1f', borderRadius: '8px', marginBottom: '12px' }}>
                  <div style={{ fontSize: '20px', marginRight: '12px', color: '#ffffff' }}>△</div>
                  <div>
                    <p style={{ fontSize: '14px', fontWeight: '500', color: '#ff6b6b', margin: '0 0 2px 0' }}>Zone C pH Critical</p>
              ...
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#ffffff', marginBottom: '16px', marginTop: 0 }}>Today's Harvest</h3>
                {harvestPredictions.slice(0, 2).map((item, index) => (
                  <div key={index} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                    <div>
                      <p style={{ fontSize: '14px', fontWeight: '500', color: '#ffffff', margin: '0 0 2px 0' }}>{item.crop}</p>
                      <p style={{ fontSize: '12px', color: '#888888', margin: 0 }}>Est. {item.date}</p>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <p style={{ fontSize: '14px', fontWeight: 'bold', color: '#00FF00', margin: '0 0 2px 0' }}>{item.yield}</p>
                      <p style={{ fontSize: '12px', color: '#888888', margin: 0 }}>{item.confidence}% confidence</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '24px' }}>
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <p style={{ fontSize: '14px', color: '#888888', margin: '0 0 4px 0' }}>Active Plants</p>
                    <p style={{ fontSize: '32px', fontWeight: 'bold', color: '#ffffff', margin: 0 }}>1,247</p>
                  </div>
                  <div style={{ fontSize: '48px', color: '#ffffff' }}>◉</div>
                </div>
                <p style={{ fontSize: '14px', color: '#00FF00', margin: '16px 0 0 0' }}>↗ 12% from last month</p>
              </div>

              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <p style={{ fontSize: '14px', color: '#888888', margin: '0 0 4px 0' }}>Avg Health Score</p>
                    <p style={{ fontSize: '32px', fontWeight: 'bold', color: '#ffffff', margin: 0 }}>89%</p>
                  </div>
                  <div style={{ fontSize: '48px', color: '#ffffff' }}>▤</div>
                </div>
              ...
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <p style={{ fontSize: '14px', color: '#888888', margin: '0 0 4px 0' }}>Water Usage</p>
                    <p style={{ fontSize: '32px', fontWeight: 'bold', color: '#ffffff', margin: 0 }}>847L</p>
                  </div>
                  <div style={{ fontSize: '48px', color: '#ffffff' }}>◎</div>
                </div>
              ...
              <div style={{ backgroundColor: '#2a2a2a', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0,0,0,0.2)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div>
                    <p style={{ fontSize: '14px', color: '#888888', margin: '0 0 4px 0' }}>Energy Usage</p>
                    <p style={{ fontSize: '32px', fontWeight: 'bold', color: '#ffffff', margin: 0 }}>23.4kW</p>
                  </div>
                  <div style={{ fontSize: '48px', color: '#ffffff' }}>◈</div>
                </div>
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#e5e5e5', padding: '20px' }}>
      {/* Main Container */}
      <div style={{ 
        backgroundColor: '#1a1a1a', 
        borderRadius: '16px', 
      ...
      {/* Header */}
      <header style={{ backgroundColor: 'transparent', padding: '24px 32px', borderBottom: '1px solid #333' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            <h1 style={{ fontSize: '32px', fontWeight: 'bold', color: '#ffffff', margin: '0 0 8px 0' }}>Welcome back, Farmer</h1>
            <p style={{ fontSize: '16px', color: '#888888', margin: 0 }}>Here's your agriculture overview</p>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <div style={{ display: 'flex', gap: '8px' }}>
              <button style={{ padding: '8px 16px', backgroundColor: '#333', color: '#888', border: 'none', borderRadius: '8px', fontSize: '14px', cursor: 'pointer' }}>12 months</button>
              <button style={{ padding: '8px 16px', backgroundColor: '#333', color: '#888', border: 'none', borderRadius: '8px', fontSize: '14px', cursor: 'pointer' }}>24 hours</button>
              <button style={{ padding: '8px 16px', backgroundColor: '#333', color: '#888', border: 'none', borderRadius: '8px', fontSize: '14px', cursor: 'pointer' }}>30 days</button>
              <button style={{ padding: '8px 16px', backgroundColor: '#00AA00', color: '#000', border: 'none', borderRadius: '8px', fontSize: '14px', cursor: 'pointer', fontWeight: '600' }}>7 days</button>
            </div>
            <div style={{ fontSize: '24px', color: '#ffffff' }}>◇</div>
          </div>
        </div>
      </header>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      cursor: 'pointer',
                      backgroundColor: activeSection === item.id ? '#00AA00' : 'transparent',
